...
\tagline{Digital Technology Strategy Specialist @ Leonardo -- Cyber \& Security Solutions}
%% You can add multiple photos on the left or right
\photoR{2.8cm}{suit2.jpg}
...
\personalinfo{%
	...
	\dateofbirth{DOB 1993-01-27} \hspace{-6mm}
	\location{Rome, IT} \\
	\homepage{andreagalle.github.io/cv} \hspace{8mm}
	% \twitter{@GallegatiAndrea}
	\linkedin{andrea-gallegati} \hspace{1mm}
	\github{andreagalle} \hspace{2mm}
