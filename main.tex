...
\iflongversion
	...
	\begin{itemize}
		...
		\item \textbf{Cyber-Risk \& Supply Chain Management} – Run threat and risk assessments on new features as well as suppliers (SBOM + vendor due-diligence), producing corrective-action reports for the Security Manager.
